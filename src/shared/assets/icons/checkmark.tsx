...
const CheckMarkIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => {
  return (
    <svg
      fill={'none'}
      height={'16'}
...
export { ForwardRef as CheckMarkIcon }
